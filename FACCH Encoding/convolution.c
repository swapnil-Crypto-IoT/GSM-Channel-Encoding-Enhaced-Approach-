...
unsigned int bits_228[228]={0};
unsigned int *convolution(unsigned int *bits_184)
{
    //unsigned int g0=0x13,g1=0x1b;
	    
	//unsigned int M[5]={0,1,0,0,1};
 ...
 */   
	...
	// printf("\n");
	 ...
	 /*taping the register */
	 temp1=G0[2]^G0[3]^bits_184[j];
      temp2=G1[0]^G1[2]^G1[3]^bits_184[j];
      output1=temp1&0x1;
	 output2=temp2&0x1;

	bits_228[j*2]= output1;
	bits_228[(j*2)+1] = output2;
...
/*	printf("\n******************* 228 bits  convolution prg output  ****************************** \n\n");
	for(i=0;i<228;i++)
	{
		printf("%d", bits_228[i]);
	}
